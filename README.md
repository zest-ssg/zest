...
The `md` helper renders a Markdown string to an HTML string, so you can blend
prose with the F# HTML DSL in the same page — `md` returns a plain `string`,
just like every other DSL builder:
