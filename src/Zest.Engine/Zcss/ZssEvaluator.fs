...
module Evaluator =
    ...
    // NOTE: The ShorthandMap (property name abbreviation module) has been removed.
    // ZSS now requires full CSS property names (e.g. "margin" instead of "m",
    // "display" instead of "d"). This improves clarity and reduces ambiguity.
